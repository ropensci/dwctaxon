...
- The `paste3()` function by IRTFM on [Stack Overflow](https://stackoverflow.com/questions/13673894/suppress-nas-in-paste) is used per [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/).
